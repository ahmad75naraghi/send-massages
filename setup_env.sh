...
KEYS=(
  ...
  SOROUSH_CHANNEL_ID SOROUSH_CHANNEL_NAME SOROUSH_BOT_TOKEN SOROUSH_CHAT_ID
  IGAP_CHANNEL_ID IGAP_CHANNEL_NAME IGAP_ITEM_ID
  USERBOT_TIMEOUT_SEC MEDIA_MAX_RETRY SYNC_GAP_SEC CHECK_INTERVAL_SEC
